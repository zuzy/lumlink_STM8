...
void show_adc(void)
{
	...
	Lcd_Puts(0,0,(uchar*)string_adc);
	Lcd_Puts(5,0,"mg");
	UART1_SendString("\t甲醛含量：",12);
	UART1_SendString(string_adc,6);
	UART1_SendString("mg/m3",5);
	UART1_SendString("\r\n",2);
#endif
